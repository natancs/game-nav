...
function start() {
  ...
  function explosao1(inimigo1X, inimigo1Y) {
    ...
    $("#explosao1").css("background-image", "url(public/imgs/explosao.png)");
    let div = $("#explosao1");
  ...
  function explosao2(inimigo2X, inimigo2Y) {
    ...
    $("#explosao2").css("background-image", "url(/public/imgs/explosao.png)");
    let div2 = $("#explosao2");
  ...
  function energia() {
    if (energiaAtual == 3) {
      $("#energia").css("background-image", "url(./public/imgs/energia3.png)");
    }
    if (energiaAtual == 2) {
      $("#energia").css("background-image", "url(./public/imgs/energia2.png)");
    }
    if (energiaAtual == 1) {
      $("#energia").css("background-image", "url(./public/imgs/energia1.png)");
    }
    if (energiaAtual == 0) {
      $("#energia").css("background-image", "url(./public/imgs/energia0.png)");
      //Game Over
      gameOver()
    }
  }
